...
export const LOCATIONS_PART1: CityConfig[] = [
    {
        ...
        subheadline: 'An unserem Stammsitz verschmelzen meisterliche Handwerkstradition und visionärer Landschaftsbau.',
        metaTitle: 'Premium Garten  & Landschaftsbau Werdorf | Memo BauT',
        metaDescription: 'Ihr Experte für exklusiven Landschaftsbau direkt in Werdorf (35614). Von Erdarbeiten über Natursteinmauern bis zu exklusiven Terrassen. Kostenlose Erstberatung.',
    ...
    },
    {
        ...
        subheadline: 'Wo historische Bedeutung auf zeitgenössischen Premium Landschaftsbau trifft. Wir schaffen exklusive Rückzugsorte im Lahn Dill Kreis Zentrum.',
