...
export const LOCATIONS_PART3: CityConfig[] = [
    {
        ...
        metaDescription: 'Hochwertige Gartengestaltung in Gießen (35390). Spezialist für Dachterrassen, Poolanlagen und exklusive Stadtgärten. Jetzt Beratung anfordern.',
        ...
        fokusLeistungen: ['Premium Terrassenbau', 'Dachterrassen & Lounges', 'Sichtschutz & Zäune'],
        ...
        faqItems: [
            ...
            { q: 'Gestalten Sie auch Dachterrassen in Gießener Neubauten?', a: 'Dachterrassengestaltung und die Ausstattung luxuriöser Penthouse Terrassen mit hochwertigen Gefäßen und Keramikböden sind unser Spezialgebiet.' },
            { q: 'Bieten Sie für Gießener Kunden moderne Lichtsysteme an?', a: 'Ja, hochwertige, app gesteuerte Premium Beleuchtung integrieren wir auf Wunsch nahtlos in unsere urbanen Gartenkonzepte.' },
    ...
    },
    {
        ...
        faqItems: [
            { q: 'Planen Sie in Butzbach auch Regenwasser Versickerungsanlagen ein?', a: 'Da die Versiegelung vielerorts in der Wetterau reglementiert ist, integrieren wir smarte Zisternen, Eco Pflaster oder Retentions Mulden nahtlos in die Außenanlage.' },
    ...
    },
    {
        ...
        metaDescription: 'Memo BauT bringt exklusiven Landschaftsbau in die Kurstadt Bad Nauheim (61231). Dachterrassen, Natursteinmauern und exklusive Terrassen in Premium Qualität.',
        ...
        fokusLeistungen: ['Exklusive Natursteinarbeiten', 'Keramik  & Edelpflaster', 'Repräsentative Vorgärten'],
        ...
        faqItems: [
            ...
            { q: 'Verwenden Sie für Bad Nauheimer Gärten besondere Materialien?', a: 'Ja, wir arbeiten oft mit exklusiven Materialien wie Travertin oder großformatiger Keramik, die stilistisch perfekt zu den Villen und Kurparks in Bad Nauheim passen.' },
